...
namespace _106_Quiz6
{
    ...
    {
        private Shape[] shapeArr = new Shape[100];
        public Form1()
        {
            InitializeComponent();
        }
        ...
        private void btnAddShape_Click(object sender, EventArgs e)
        {
            ...
            {
                case "球":
                    shapeArr[Shape.Amount] = new Ball(Double.Parse(txtPara1.Text), Double.Parse(txtDensity.Text));
                    break;
                case "立方體":
                    shapeArr[Shape.Amount] = new Cube(Double.Parse(txtPara1.Text), Double.Parse(txtDensity.Text));
                    break;
                case "圓柱體":
                    shapeArr[Shape.Amount] = new Cylinder(Double.Parse(txtPara1.Text), Double.Parse(txtPara2.Text),Double.Parse(txtDensity.Text));
                    break;
                case "金字塔":
                    shapeArr[Shape.Amount] = new Pyramid(Double.Parse(txtPara1.Text), Double.Parse(txtPara2.Text),Double.Parse(txtDensity.Text));
                    break;
                default:
                    break;
            }
